...
- ✅ Signed with Developer ID (Example Organisation)
...
```
Certificate: Developer ID Installer: Example Organisation (TEAMID0000)
...
1. ✅ Developer ID Installer: Example Organisation
...
├── url: https://munki.example.com/bootstrap/management.json
